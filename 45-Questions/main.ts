...
let message: string = `Hello${personName}, Whould you like to learn some TypeScript today?`;
console.log(message);

//Question 3: Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.

let personsName: string = "alice";
...
console.log(
  personsName.charAt(0).toUpperCase() + personsName.slice(1).toLowerCase()
); //Shows only first letter in captial
...
console.log(
  "Imran Khan once said, The more you study, the more you know how less you know.`;"
);
...
let famousPerson: string = "Imran Khan";
...
let myName: string = "Ayesha"; //My name
let date: number = 11; //Todays date
...
let myFriends: string[] = ["Alice", "Emma", "Lisa"];
...
let PersonsName: string[] = ["Alice", "Emma", "Lisa"];
...
let transport: string[] = ["Toyota Fortuner", "Honda BRV", "Audi Q8"];
...
let guest: string[] = ["Elon Musk", "Albert Einstein", "Bill Gates"];
guest.forEach((guest) => {
...
console.log(
  "The new Dinner table won’t arrive in time for the dinner, and i can invite only two guests."
);
...
console.log(`I am iniviting ${guests} people to the dinner`);
...
console.log(
  `Shirt Details: This ${shirt.color} Shirt in ${shirt.size} Size is for ${shirt.price}rs.`
);
...
function makeShirt(size: string = "Large", text: string = "Never Give Up!") {
  console.log(`Making a "${size}" T-Shirt with "${text}" written on it`);
}
makeShirt(); //Deafault
makeShirt("Small");
...
let magicians: string[] = ["Charles", "Chris", "Taylor"];
